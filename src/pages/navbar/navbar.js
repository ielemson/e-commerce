...
" />
                ...
                <div className="header_social">
                    <ul>
                        <li><a href="/">1<i className="fa fa-pinterest" aria-hidden="true"></i></a></li>
                        <li><a href="/">1<i className="fa fa-instagram" aria-hidden="true"></i></a></li>
                        <li><a href="/">1<i className="fa fa-facebook" aria-hidden="true"></i></a></li>
                        <li><a href="/">1<i className="fa fa-twitter" aria-hidden="true"></i></a></li>
                    </ul>
                </div>
            </header>
                    ...
                    <div className="page_menu_content">
                        ...
                        <ul className="page_menu_nav menu_mm">
                            <li className="page_menu_item has-children menu_mm">
                                <a href="index-2.html">Home<i className="fa fa-angle-down"></i></a>
